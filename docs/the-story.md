...
See [the Code documentation]({% link docs/Windows/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Callouts]({% link docs/Windows/callouts.md %}) for more information.
