...
This is most commonly-used to define [custom callout colors]({% link docs/the-story.md %}#callouts). For example,
...
This content appears at the bottom of every page's main content. More info for this include can be found in the [Configuration - Footer content]({% link docs/the-story.md %}#footer-content).
