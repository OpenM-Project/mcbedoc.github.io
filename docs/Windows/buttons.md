...
Wrap the button in a container that uses the [font-size utility classes]({% link docs/Android/typography.md %}) to scale buttons:
...
Use the [margin utility classes]({% link docs/Android/layout.md %}#spacing) to add spacing between two buttons in the same block.
